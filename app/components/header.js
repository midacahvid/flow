...
export default function Header() {
  return (
    <header>
      <nav className="bg-headercolors border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          <Image src="/logo.png" height={50} width={50} />
          <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white text-logocolor lg:-ml-80">
            Flow LLM
          </span>
          ...
          <div className="flex items-center lg:order-2">
            <Link
              href="#"
              className="text-white bg-btncolor hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800"
            >
              Login
            </Link>
            <button
